...
import { getConstructionServiceBySlug, getConstructionServicesWithPagination, getGlobalConfig } from '@/lib/server/pages';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const service = await getConstructionServiceBySlug(slug);
  ...
  return {
    title: `${service.title} | Thi Công Nội Thất | Nội Thất Tuấn Vương`,
    description: service.shortDescription || service.description,
    keywords: ['thi công nội thất', service.title.toLowerCase(), 'nội thất tuấn Vương'],
    alternates: {
      canonical: `https://noithattuanvuong.vn/thi-cong/${service.slug}`,
    },
    openGraph: {
      title: `${service.title} | Nội Thất Tuấn Vương`,
      description: service.shortDescription || service.description,
      url: `https://noithattuanvuong.vn/thi-cong/${service.slug}`,
...
export default async function ThiCongDetailPage({ params }: PageProps) {
  const { slug } = await params;
  const [service, servicesResult, globalConfig] = await Promise.all([
    getConstructionServiceBySlug(slug),
    getConstructionServicesWithPagination(1),
    getGlobalConfig(),
  ]);
    ...
    <>
          ...
          <div className="container relative z-10">
            ...
            <nav className="mb-6">
              <ol className="flex items-center gap-2 text-sm text-white/60!">
                ...
                <li>/</li>
                <li>
                  <Link href="/thi-cong" className="hover:text-white!">Thi công nội thất</Link>
                </li>
                <li>/</li>
        ...
        <section className="py-8 bg-white">
          <div className="container">
            ...
            >
              <ArrowLeft size={18} />
              Quay lại danh sách dịch vụ thi công
            </Link>
          </div>
        </section>
